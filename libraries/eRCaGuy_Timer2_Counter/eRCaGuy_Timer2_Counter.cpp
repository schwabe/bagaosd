...
unsigned long eRCaGuy_Timer2_Counter::get_T2_count()
{
  ...
  //Airmamaf modif
  SREG = oldSREG; //interrupts(); //allow interrupts again
...
//Airmamaf get direct micros value
unsigned long eRCaGuy_Timer2_Counter::get_T2_umicros() 
{
    return get_T2_count()>>1;
}
