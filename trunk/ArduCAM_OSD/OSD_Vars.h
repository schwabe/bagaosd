...
static uint16_t 	osd_eph = 0;                    //Airmamaf GPS HDOP horizontal dilution of position in cm (m*100)
static uint8_t    osd_battery_pic_A = 0xb4;       // Airmamaf picture to show battery remaining
...
static float        start_Time = 0.0; //Airmamaf -1.0;
